...
import { allCourses,deleteCourse } from "../../redux/slices/courseSlice";
...
function AdminDashboard() {
        ...
        datasets: [
            {
                ...
                backgroundColor: ["#3376BD", "#4CAF50"],
                borderWidth: 1,
                borderColor: ["#1e88e5","#4CAF50"]
            },
        ]
    };
    ...
    return (
        <HomeLayout>
            <div className="min-h-[90vh] mt-20 pt-5 flex flex-col flex-wrap gap-10 text-white">
                ...
                <div className="grid grid-cols-2 gap-5 m-auto mx-10">
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 shadow-[0_0_10px_black] rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-[0_0_10px_black]">
                                <div className="flex flex-col items-center">
                                    <p className="font-semibold">Registered Count</p>
                                    <h3 className="text-4xl font-bold">{allPayments?.count}</h3>
                                </div>
                                <FcSalesPerformance className="text-blue-500 text-5xl"/>
                            </div>
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-[0_0_10px_black]">
                                <div className="flex flex-col items-center">
                ...
                <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
                    <div className="flex w-full items-center justify-between">
                        ...
                        <button
                            ...
                            className="w-fit bg-blue-500 hover:bg-blue-600 transition-all ease-in-out duration-300 rounded py-2 px-4 font-semibold text-lg cursor-pointer"
                        >
                            Create new course
                        </button>
                    </div>
                                        ...
                                        <tr key={course._id}>
                                            ...
                                            <td className="flex items-center gap-4">
                                                <button
                                                    ...
                                                    onClick={() => navigate("/dashboard/dispalyLectures", {state: {...course}})}
                                                >
